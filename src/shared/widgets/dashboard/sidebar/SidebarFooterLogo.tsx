...
export const SidebarFooterLogo = () => {
  return (
    <div className="flex w-[90%] items-center justify-start relative">
      <svg
        version="1.1"
        id="a"
        ...
        className="fill-current h-5 text-gray-700 ml-1"
      >
        <g id="b">
          <g id="c">
            <g>
      ...
      <h5 className="absolute left-8 pt-1 opacity-[.8] font-light text-base">
        ENewsletter
      </h5>
    </div>
  );
