  ...
  return (
    <div className="w-full md:flex items-center bg-[#9399f4] py-5 text-center md;py-0 md:text-left md:min-h-[55vh]">
      ...
      <div className="md:w-[50%]">
        <h2 className="font-clashDisplay uppercase text-3xl md:text-5xl text-cyber-ink mx-auto mb-2 md:text-left">
          CREATE
        </h2>
        ...
        <br />
        <p className="text-cyber-ink text-xl md:text-2xl max-w-lg ">
          Warning: A writing experience unlike anything you&lsquo;ve ever
          experienced - proceed with caution.
        </p>

        <br />
        <Button className="bg-white border-2 border-[#000] rounded-xl text-xl !p-7 !px-16">
          Start building
        </Button>
      </div>
    </div>
